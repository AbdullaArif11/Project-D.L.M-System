...
if (mysqli_num_rows($result) > 0) { // check if any rows were returned
  ...
  <tr>
    ...
    <th style="border: 3px solid black;">Date of Birth</th>
    <th style="border: 3px solid black;">Blood group</th>
    <th style="border: 3px solid black;">Father/Husband Name</th>
    <th style="border: 3px solid black;">Issue/Renewal</th>
    <th style="border: 3px solid black;">Validity</th>
    <th style="border: 3px solid black;">License No</th>
    <th style="border: 3px solid black;">Issuing Authority</th>
    <th style="border: 3px solid black;">Address</th>
    <th style="border: 3px solid black;">Class of Vehicles</th>
  ...
  while($row = mysqli_fetch_assoc($result)) {
    echo "<tr>
      ...
      <td style='border: 2px solid black;'>".$row["Validity"]."</td>
      <td style='border: 2px solid black;'>".$row["LIcence_no"]."</td>
      <td style='border: 2px solid black;'>".$row["Issuing_Aurthrority"]."</td>
      <td style='border: 2px solid black;'>".$row["Address"]."</td>
      <td style='border: 2px solid black;'>".$row["Class_of_vehicle"]."</td>
